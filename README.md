...
Modulos/: Paquete que contiene la lógica central del sistema:


menu.py: Gestiona la interfaz de usuario por consola y la navegación entre opciones. 


gestion_datos.py: Contiene las funciones para el manejo, almacenamiento y procesamiento de la información. 


validaciones.py: Módulo especializado en asegurar que los datos ingresados cumplan con los formatos requeridos (strings, números, etc.). 


datos_basicos.py: Define las estructuras de datos o variables iniciales necesarias para el proyecto. 
...
Validación Robusta: Control de errores en la entrada de datos para prevenir fallos en tiempo de ejecución. 


Modularidad: Uso de paquetes y módulos (__init__.py) para una arquitectura limpia. 


Gestión Documentada: El código incluye comentarios y docstrings para explicar la lógica interna (según los logs de commit). 

🛠️ Tecnologías Utilizadas

Lenguaje: Python 3.14 (detectado por archivos .pyc). 
+2


Control de Versiones: Git (repositorio inicializado incluido). 
